        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
          ...
          <div className="p-6 sm:p-8">
            ...
            {blog.image && (
              <div className="mb-6 sm:mb-8 flex justify-center">
                <div className="group cursor-pointer relative">
                  <div className="w-96 h-56 rounded-xl overflow-hidden border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-400 relative">
                    ...
                    <img
                      src={blog.image}
                      alt={blog.title}
                      className="w-full h-full object-cover transition-transform duration-600 group-hover:scale-110 relative z-0"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="mb-6 sm:mb-8">
              {isHTML(blog.intro) ? (
                <div
                  className="text-base sm:text-lg text-gray-700 leading-relaxed bg-gray-50 p-4 sm:p-6 rounded-xl border-l-4 border-green-500"
          ...
          <div className="px-4 sm:px-8 pb-6 sm:pb-8">
            {blog.sections?.map((section, i) => (
              ...
              >
                ...
                {/* Content */}
                {section.content && (
                  isHTML(section.content) ? (
                    <div
                      className="text-gray-700 leading-relaxed text-base mt-2"
            ...
            <div className="flex flex-wrap gap-4 justify-center items-center">
              ...
              <div className="flex gap-3">
                {[FaTwitter, FaLinkedin, FaFacebook].map((Icon, idx) => (
                  <button
                    key={idx}
                    className="w-10 h-10 rounded-full bg-[#66a038]/90 flex items-center justify-center hover:bg-[#66a038] transition-all duration-500 shadow-sm hover:scale-110 hover:shadow-lg group relative overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                    <Icon className="w-4 h-4 text-white relative z-10 transition-all duration-500 group-hover:scale-125 group-hover:rotate-90" />
                  </button>
                ))}
              </div>
            </div>
