...
export default function InsuredBanner() {
  return (
    <div className="w-full flex flex-col lg:flex-row items-stretch justify-between rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 bg-white group relative">
      ...
      <div className="w-full lg:w-1/3 flex items-center justify-center bg-[#66a038] relative overflow-hidden p-8 md:p-12 lg:absolute lg:right-8 lg:top-8 lg:bottom-8 lg:rounded-2xl">
        {/* Background Pattern */}
        ...
        <div className="relative text-center space-y-6 transform group-hover:scale-105 transition-transform duration-500">
          ...
          {/* Main Heading - Your Original Content */}
          ...
          {/* Your Original Separator - Enhanced */}
          <div className="flex justify-center">
            <div className="h-1.5 w-20 bg-white rounded-full transform group-hover:scale-110 transition-transform duration-300"></div>
          </div>
        </div>
      </div>
