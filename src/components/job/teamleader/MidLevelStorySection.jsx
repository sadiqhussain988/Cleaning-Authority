    ...
    <div className="w-full">
      ...
      >
        ...
        <p className="max-w-3xl mx-auto text-lg leading-relaxed text-gray-700">
          ...
          Monday–Friday daytime hours, so you're free to do what you enjoy on
          the weekends. Every weekend.
        </p>
          ...
          <div className="relative" data-aos="fade-left">
            ...
            <div className="bg-[#A9E5F3] rounded-[50px] p-10 shadow-md relative">
              <p className="text-3xl md:text-4xl font-extrabold text-gray-900">
                “I like my work. <br /> I like being here.”
              </p>
            </div>

            {/* BROOM IMAGE — Increased size */}
            <img
              src={BROOM_IMG}
              alt="Cleaning tool"
              className="absolute -top-10 right-0 w-60 md:w-72 rotate-3 drop-shadow-xl"
            />

            {/* PERSON IMAGE — Increased size with valid Tailwind sizes */}
            <div className="mt-10 text-center">
              <img
                src={PERSON_IMG}
                alt="Employee"
                className="w-72 h-72 mx-auto rounded-full object-cover border-4 border-white shadow-lg"
              />
