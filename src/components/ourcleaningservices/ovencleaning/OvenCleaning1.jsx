...
export default function OvenCleaning1() {
  const services = [
  ...
  const sections = [
    { icon: <FaClock className="text-blue-400 text-xl" />, title: "Get the Impeccable Clean That You Deserve", text: "Maintaining a pristine home environment is essential. We recommend regular cleaning to keep your space hygienic." },
    { icon: <FaStar className="text-[#66A038] text-xl" />, title: "Oven Cleaning FAQ", text: "Save time & effort with higher-standard cleaning that reduces bacteria and allergens." },
    { icon: <FaCheckCircle className="text-purple-400 text-xl" />, title: "Schedule a Professional Oven Cleaning Service", text: "Our trained team delivers detailed cleaning using premium products and expert techniques." },
