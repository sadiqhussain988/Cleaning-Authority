...
export default function OneTimeCleaning() {
  ...
  const sections = [
    { icon: <FaClock className="text-blue-400 text-xl" />, title: "Our One-Time Cleaning Service", text: "Maintaining a pristine home environment is essential. We recommend regular cleaning to keep your space hygienic." },
    { icon: <FaStar className="text-[#66A038] text-xl" />, title: "The Areas We Clean", text: "Save time & effort with higher-standard cleaning that reduces bacteria and allergens." },
    { icon: <FaCheckCircle className="text-purple-400 text-xl" />, title: "Common One-Time Only Cleaning Tasks", text: "Our trained team delivers detailed cleaning using premium products and expert techniques." },
