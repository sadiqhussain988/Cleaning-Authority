...
export default function AfterModel() {
  const services = [
  ...
  const sections = [
    { icon: <FaClock className="text-blue-400 text-xl" />, title: "Professional Construction Cleanup & Post-Renovation Cleaning", text: "We know few people have the spare time and energy to clean, and that's why we provide cleaning and sanitizing services meant specifically for apartments, condos, and living spaces of any size. From a one-bedroom apartment to a large condominium, we can clean your whole living space so you can sit back and enjoy the comfort and peace of mind that comes with living in a clean and sanitized space." },
    { icon: <FaStar className="text-[#66A038] text-xl" />, title: "The Phases of Post-Construction Cleanup", text: "Save time & effort with higher-standard cleaning that reduces bacteria and allergens." },
    { icon: <FaCheckCircle className="text-purple-400 text-xl" />, title: "Post-Renovation Cleanup FAQ", text: "Our trained team delivers detailed cleaning using premium products and expert techniques." },
    { icon: <FaLeaf className="text-[#66A038] text-xl" />, title: "There's a Reason We're the Authority on Cleaning", text: "We use sustainable, eco-friendly, and safe cleaning products for your home." },
