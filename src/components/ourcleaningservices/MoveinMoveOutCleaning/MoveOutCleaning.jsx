...
export default function MoveOutCleaning() {
  ...
  const sections = [
    { icon: <FaClock className="text-blue-400 text-xl" />, title: "Professional Move Out Cleaning Services in Southern California", text: "Maintaining a pristine home environment is essential. We recommend regular cleaning to keep your space hygienic." },
    { icon: <FaStar className="text-[#66A038] text-xl" />, title: "What to Expect From Our Move Out Cleaning Services", text: "Save time & effort with higher-standard cleaning that reduces bacteria and allergens." },
    { icon: <FaCheckCircle className="text-purple-400 text-xl" />, title: "House Cleaning in Irvine That Supports Your Move", text: "Our trained team delivers detailed cleaning using premium products and expert techniques." },
    { icon: <FaLeaf className="text-[#66A038] text-xl" />, title: "Move In Cleaning for a Fresh Start", text: "We use sustainable, eco-friendly, and safe cleaning products for your home." },
