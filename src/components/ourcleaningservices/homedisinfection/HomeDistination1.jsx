...
export default function HomeDistination1() {
  const services = [
  ...
  const sections = [
    { icon: <FaClock className="text-blue-400 text-xl" />, title: "The Spaces We Disinfect", text: "We know few people have the spare time and energy to clean, and that's why we provide cleaning and sanitizing services meant specifically for apartments, condos, and living spaces of any size. From a one-bedroom apartment to a large condominium, we can clean your whole living space so you can sit back and enjoy the comfort and peace of mind that comes with living in a clean and sanitized space." },
    { icon: <FaStar className="text-[#66A038] text-xl" />, title: "Why Choose Professional Disinfecting Services Over DIY?", text: "Save time & effort with higher-standard cleaning that reduces bacteria and allergens." },
    { icon: <FaCheckCircle className="text-purple-400 text-xl" />, title: "Why Call The Cleaning Authority?", text: "Our trained team delivers detailed cleaning using premium products and expert techniques." },
