      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-8">
        ...
        <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="lg:w-3/5">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-gray-800 mb-6 bg-gradient-to-r from-blue-300 to-[#82c24d] bg-clip-text text-transparent drop-shadow-lg">
