...
export default function OfficeClean() {
  const services = [
  ...
  const sections = [
    { icon: <FaClock className="text-blue-400 text-xl" />, title: "We Clean, Sanitize & Disinfect Office Spaces", text: "We know few people have the spare time and energy to clean, and that's why we provide cleaning and sanitizing services meant specifically for apartments, condos, and living spaces of any size. From a one-bedroom apartment to a large condominium, we can clean your whole living space so you can sit back and enjoy the comfort and peace of mind that comes with living in a clean and sanitized space." },
    { icon: <FaStar className="text-[#66A038] text-xl" />, title: "What Our Office Cleaners Do", text: "Save time & effort with higher-standard cleaning that reduces bacteria and allergens." },
    ...
    { icon: <FaLeaf className="text-[#66A038] text-xl" />, title: "Office Kitchen Cleaning", text: "We use sustainable, eco-friendly, and safe cleaning products for your home." },
    { icon: <FaDollarSign className="text-yellow-600 text-xl" />, title: "Office Disinfection Services", text: "We provide competitive and transparent pricing tailored to your needs." },
    { icon: <FaListAlt className="text-indigo-400 text-xl" />, title: "Office Cleaning FAQ", text: "Standard cleaning maintains cleanliness while deep cleaning gives a complete detailed refresh." },
