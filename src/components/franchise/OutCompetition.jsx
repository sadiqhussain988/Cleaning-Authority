...
const OutCompetition = () => {
  ...
  return (
    <section className="py-15 md:py-20 px-5 md:px-20 bg-gradient-to-b from-[#F7FBFF] to-white">
      <h2
        className="text-4xl md:text-5xl font-bold text-center text-[#0079C1] max-w-3xl mx-auto mb-6 drop-shadow-sm"
        data-aos="fade-down"
      >
      ...
      <p
        className="text-lg text-gray-700 text-center max-w-3xl mx-auto mb-10 leading-relaxed"
        data-aos="fade-up"
      >
        Curious if the home cleaning franchise industry is right for you? Contact
        us today at <span className="text-[#0079C1]">(888) 718-4534</span> or
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-8">
          {cards.map((card, idx) => (
            <div
              key={idx}
              className="flex flex-col items-start p-3 bg-white rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-500 border border-[#dceefa] max-w-sm"
              data-aos="fade-right"
        ...
        {/* RIGHT SIDE FORM */}
        <div
          className="bg-[#0079C1] p-5 md:p-10 rounded-3xl shadow-xl border-2 border-white/30"
          data-aos="fade-left"
        >
          ...
          <p className="text-gray-100 text-sm mb-6 leading-relaxed">
            Interested parties must have a minimum $50,000 cash on hand to invest
            in a franchise. We are currently only accepting franchise applications
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-white text-sm leading-relaxed">
                By checking this box, I consent to receive recurring text messages
                regarding franchise opportunities. Msg & data rates may apply.{" "}
                <span className="text-yellow-200 underline hover:text-white cursor-pointer">
                  Privacy Policy
                </span>
                .
              </p>
