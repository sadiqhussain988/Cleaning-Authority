...
const BecomeOwner = () => {
  ...
  return (
    <section className="py-15 md:py-20 px-5 md:px-20 bg-gradient-to-br from-[#EAF4F5] to-[#ffffff]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">

        {/* LEFT SIDE CONTENT */}
        <div className="flex flex-col justify-start text-center md:text-left" data-aos="fade-right">
            
          <h2 className="text-4xl md:text-5xl font-extrabold text-[#0079C1] mb-3 tracking-tight drop-shadow-sm" data-aos="fade-down" data-aos-delay="100">
            Become an Owner
          </h2>
          <p className="text-2xl md:text-3xl font-semibold text-gray-700 drop-shadow-sm mb-6" data-aos="fade-down" data-aos-delay="200">
            Franchise with The Cleaning Authority
          </p>

          <p className="text-gray-600 text-lg mb-10 leading-relaxed max-w-lg" data-aos="fade-up" data-aos-delay="300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <button
              className="px-8 py-3 bg-[#0079C1] text-white rounded-xl shadow-lg font-medium hover:bg-[#00609a] transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-1"
            ...
            <button
              className="px-8 py-3 bg-[#4fa33a] text-white rounded-xl shadow-lg font-medium hover:bg-[#3f8c30] transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-1"
        ...
        {/* RIGHT SIDE FORM */}
        <div className="bg-[#0079C1] p-5 md:p-10 rounded-3xl shadow-2xl border-2 border-white/30" data-aos="fade-left">
          
          <h3 className="text-2xl font-bold text-center text-white mb-2" data-aos="fade-down" data-aos-delay="100">
            Ready to Build a Rewarding Business?
          </h3>

          <p className="text-center text-gray-200 mb-3 text-sm" data-aos="fade-up" data-aos-delay="200">
            Fill out the form and our franchise development team will contact you.
          </p>

          <p className="text-gray-100 text-sm mb-5 leading-relaxed" data-aos="fade-up" data-aos-delay="300">
