...
const StepSuccess = () => {
  ...
  return (
    <section className="py-15 md:py-20 px-6 md:px-20 bg-[#E5F1F9]">
      <div className="max-w-7xl mx-auto text-center">

        {/* Heading */}
        <h2
          className="text-4xl md:text-5xl font-bold text-[#0079C1] mb-6"
          data-aos="fade-down"
        >
          Steps to Success
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-16">
          {steps.map((title, index) => (
            ...
            >
              ...
              <h3 className="text-[#0079C1] font-semibold">
                {title}
              </h3>
            </div>
          ))}
        ...
        {/* Button */}
        <div className="flex justify-center" data-aos="fade-up" data-aos-delay={900}>
